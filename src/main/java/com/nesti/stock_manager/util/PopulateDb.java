...
public class PopulateDb {
	...
	public static void populate() {
		...
		query = HibernateUtil.getSession().createQuery("DELETE FROM Offer");
		query.executeUpdate();
		...
		SupplierDao.saveOrUpdate(new Supplier("L'empire des fruits", "4 rue des chats", "", "34040", "Montpellier",
				"Gaston", "France", "0604040550"));
		SupplierDao.saveOrUpdate(new Supplier("Pacher Distribution", "7 avenue du roi", "", "80810", "Alès",
				"Charles Durant", "France", "0404557440"));
		...
		offer.setStartDate(FormatUtil.stringToDate("5-01-2021 19:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(3.55);
		offer.setSupplierFromName("Oeufs en folie");
		offer.setArticleFromCode("OEUF6");
		offer.setStartDate(FormatUtil.stringToDate("13-01-2021 19:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(4.55);
		offer.setSupplierFromName("Oeufs en folie");
		offer.setArticleFromCode("OEUF6");
		offer.setStartDate(FormatUtil.stringToDate("15-01-2021 19:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(3.04);
		offer.setSupplierFromName("Oeufs en folie");
		offer.setArticleFromCode("OEUF6");
		offer.setStartDate(FormatUtil.stringToDate("18-01-2021 19:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(3.45);
		offer.setSupplierFromName("L'empire des fruits");
		offer.setArticleFromCode("OEUF6");
		offer.setStartDate(FormatUtil.stringToDate("5-01-2021 11:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(4.15);
		offer.setSupplierFromName("L'empire des fruits");
		offer.setArticleFromCode("OEUF6");
		offer.setStartDate(FormatUtil.stringToDate("13-01-2021 11:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(3.55);
		offer.setSupplierFromName("L'empire des fruits");
		offer.setArticleFromCode("OEUF6");
		offer.setStartDate(FormatUtil.stringToDate("15-01-2021 11:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(5.04);
		offer.setSupplierFromName("L'empire des fruits");
		offer.setArticleFromCode("OEUF6");
		offer.setStartDate(FormatUtil.stringToDate("18-01-2021 11:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(null);
		offer.setSupplierFromName("L'empire des fruits");
		offer.setArticleFromCode("OEUF6");
		offer.setStartDate(FormatUtil.stringToDate("18-03-2021 11:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(3.92);
		offer.setSupplierFromName("L'empire des fruits");
		offer.setArticleFromCode("OEUF6");
		offer.setStartDate(FormatUtil.stringToDate("18-07-2021 11:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(3.45);
		offer.setSupplierFromName("L'empire des fruits");
		offer.setArticleFromCode("CHOC94");
		offer.setStartDate(FormatUtil.stringToDate("5-01-2021 10:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(4.15);
		offer.setSupplierFromName("L'empire des fruits");
		offer.setArticleFromCode("CHOC94");
		offer.setStartDate(FormatUtil.stringToDate("13-01-2021 10:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(3.55);
		offer.setSupplierFromName("L'empire des fruits");
		offer.setArticleFromCode("CHOC94");
		offer.setStartDate(FormatUtil.stringToDate("15-01-2021 10:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(5.04);
		offer.setSupplierFromName("L'empire des fruits");
		offer.setArticleFromCode("CHOC94");
		offer.setStartDate(FormatUtil.stringToDate("18-01-2021 10:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(4.99);
		offer.setSupplierFromName("Oeufs en folie");
		offer.setArticleFromCode("OEUF12");
		offer.setStartDate(FormatUtil.stringToDate("12-01-2021 19:15:55"));
		offerDao.saveOrUpdate(offer);
		...
		offer.setSupplierFromName("Oeufs en folie");
		offer.setArticleFromCode("OEUF12");
		offer.setStartDate(FormatUtil.stringToDate("14-01-2021 19:15:55"));
		offerDao.saveOrUpdate(offer);
		...
		offer.setArticleFromCode("OEUF12");
		offer.setStartDate(FormatUtil.stringToDate("12-01-2021 10:15:55"));
		offerDao.saveOrUpdate(offer);
		...
		offer.setSupplierFromName("O'Sel Fin");
		offer.setArticleFromCode("OEUF12");
		offer.setStartDate(FormatUtil.stringToDate("14-01-2021 10:15:55"));
		offerDao.saveOrUpdate(offer);
		...
		offer.setSupplierFromName("O'Sel Fin");
		offer.setArticleFromCode("LAI85");
		offer.setStartDate(FormatUtil.stringToDate("12-01-2021 1:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(4.72);
		offer.setSupplierFromName("O'Sel Fin");
		offer.setArticleFromCode("LAI85");
		offer.setStartDate(FormatUtil.stringToDate("13-01-2021 1:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(3.25);
		offer.setSupplierFromName("O'Sel Fin");
		offer.setArticleFromCode("LAI85");
		offer.setStartDate(FormatUtil.stringToDate("14-01-2021 1:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(8.72);
		offer.setSupplierFromName("O'Sel Fin");
		offer.setArticleFromCode("LAI85");
		offer.setStartDate(FormatUtil.stringToDate("15-01-2021 1:15:55"));
		offerDao.saveOrUpdate(offer);
		...
		offer.setArticleFromCode("CASS125");
		offer.setStartDate(FormatUtil.stringToDate("12-01-2021 5:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(15.90);
		offer.setSupplierFromName("Pacher Distribution");
		offer.setArticleFromCode("CASS125");
		offer.setStartDate(FormatUtil.stringToDate("13-01-2021 5:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(14.);
		offer.setSupplierFromName("Pacher Distribution");
		offer.setArticleFromCode("CASS125");
		offer.setStartDate(FormatUtil.stringToDate("14-01-2021 5:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(17.90);
		offer.setSupplierFromName("Pacher Distribution");
		offer.setArticleFromCode("CASS125");
		offer.setStartDate(FormatUtil.stringToDate("15-01-2021 5:15:55"));
		offerDao.saveOrUpdate(offer);
		...
		offer.setStartDate(FormatUtil.stringToDate("5-01-2021 16:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(4.15);
		offer.setSupplierFromName("L'empire des fruits");
		offer.setArticleFromCode("ORA150");
		offer.setStartDate(FormatUtil.stringToDate("13-01-2021 16:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(3.55);
		offer.setSupplierFromName("L'empire des fruits");
		offer.setArticleFromCode("ORA150");
		offer.setStartDate(FormatUtil.stringToDate("15-01-2021 16:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(5.04);
		offer.setSupplierFromName("L'empire des fruits");
		offer.setArticleFromCode("ORA150");
		offer.setStartDate(FormatUtil.stringToDate("18-01-2021 16:15:55"));
		offerDao.saveOrUpdate(offer);
		...
		offer.setSupplierFromName("Pacher Distribution");
		offer.setArticleFromCode("OEUFC20");
		offer.setStartDate(FormatUtil.stringToDate("12-01-2021 13:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(14.60);
		offer.setSupplierFromName("Pacher Distribution");
		offer.setArticleFromCode("OEUFC20");
		offer.setStartDate(FormatUtil.stringToDate("13-01-2021 13:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(10.18);
		offer.setSupplierFromName("Pacher Distribution");
		offer.setArticleFromCode("OEUFC20");
		offer.setStartDate(FormatUtil.stringToDate("14-01-2021 13:15:55"));
		offerDao.saveOrUpdate(offer);

		offer = new Offer(16.90);
		offer.setSupplierFromName("Pacher Distribution");
		offer.setArticleFromCode("OEUFC20");
		offer.setStartDate(FormatUtil.stringToDate("15-01-2021 13:15:55"));
		offerDao.saveOrUpdate(offer);
		...
		offer.setSupplierFromName("Oeufs en folie");
		offer.setArticleFromCode("LOUCH50B");
		offer.setStartDate(FormatUtil.stringToDate("12-01-2021 11:15:55"));
		offerDao.saveOrUpdate(offer);
		...
		offer.setSupplierFromName("Oeufs en folie");
		offer.setArticleFromCode("LOUCH50B");
		offer.setStartDate(FormatUtil.stringToDate("14-01-2021 11:15:55"));
		offerDao.saveOrUpdate(offer);
		...
		var user = new User("james", "James Bond", FormatUtil.stringToDate("15-01-2018 1:15:55"),
				"super-administrator");
		user.setPasswordHashFromPlainText("1234");
		userDao.saveOrUpdate(user);

		user = new User("erik", "Erik Shea", FormatUtil.stringToDate("15-01-2017 1:15:55"), "administrator");
		user.setPasswordHashFromPlainText("1234");
		userDao.saveOrUpdate(user);

		var orderDao = new OrderDao();
		var order = new Order("257", FormatUtil.stringToDate("13-01-2021 1:15:55"),
				FormatUtil.stringToDate("17-01-2021 1:15:55"));
		order.setSupplierFromName("Oeufs en folie");
		order.setUserFromLogin("james");
		orderDao.saveOrUpdate(order);

		order = new Order("612", FormatUtil.stringToDate("14-01-2021 1:15:55"),
				FormatUtil.stringToDate("21-01-2021 1:15:55"));
		order.setSupplierFromName("Oeufs en folie");
		order.setUserFromLogin("erik");
		orderDao.saveOrUpdate(order);

		order = new Order("546", FormatUtil.stringToDate("15-01-2021 1:15:55"),
				FormatUtil.stringToDate("24-01-2021 1:15:55"));
		order.setSupplierFromName("O'Sel Fin");
		order.setUserFromLogin("erik");
		orderDao.saveOrUpdate(order);

		order = new Order("658", FormatUtil.stringToDate("12-01-2021 23:15:55"),
				FormatUtil.stringToDate("16-01-2021 1:15:55"));
		order.setSupplierFromName("O'Sel Fin");
		order.setUserFromLogin("erik");
		orderDao.saveOrUpdate(order);

		order = new Order("555", FormatUtil.stringToDate("13-01-2021 23:15:55"),
				FormatUtil.stringToDate("30-02-2021 1:15:55"));
		order.setSupplierFromName("Perfect cooking");
		order.setUserFromLogin("erik");
		orderDao.saveOrUpdate(order);

		order = new Order("567", FormatUtil.stringToDate("12-01-2021 23:15:55"),
				FormatUtil.stringToDate("30-02-2021 1:15:55"));
		order.setSupplierFromName("Pacher Distribution");
		order.setUserFromLogin("james");
		orderDao.saveOrUpdate(order);

		order = new Order("7467", FormatUtil.stringToDate("24-01-2021 23:15:55"),
				FormatUtil.stringToDate("30-02-2021 1:15:55"));
		order.setSupplierFromName("Pacher Distribution");
		order.setUserFromLogin("james");
		orderDao.saveOrUpdate(order);

		order = new Order("10467", FormatUtil.stringToDate("13-01-2021 23:15:55"),
				FormatUtil.stringToDate("30-02-2021 1:15:55"));
