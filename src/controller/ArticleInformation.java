...
public class ArticleInformation extends JPanel {
	...
	public ArticleInformation() {
		...
		infoArticleLeftLayout.setHorizontalGroup(infoArticleLeftLayout.createSequentialGroup()
			//	.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MIN_VALUE)
				.addGroup(infoArticleLeftLayout.createParallelGroup().addComponent(addBasketTextfield)
						.addComponent(quantityAddBasket))
				
				.addGroup(infoArticleLeftLayout.createParallelGroup().addComponent(titleInformationList))
				...
				.addGroup(infoArticleLeftLayout.createParallelGroup().addComponent(eanTextfield))
				
				.addGroup(infoArticleLeftLayout.createParallelGroup().addComponent(ingredientLabel))
				.addGroup(infoArticleLeftLayout.createParallelGroup().addComponent(ingredientTextfield))
				
				.addGroup(infoArticleLeftLayout.createParallelGroup().addComponent(descriptionLabel))
				.addGroup(infoArticleLeftLayout.createParallelGroup().addComponent(descriptionTextfield))
				
				.addGroup(infoArticleLeftLayout.createParallelGroup().addComponent(packingLabel))
				.addGroup(infoArticleLeftLayout.createParallelGroup().addComponent(packingTextfield))
				
				.addGroup(infoArticleLeftLayout.createParallelGroup().addComponent(weightLabel))
				.addGroup(infoArticleLeftLayout.createParallelGroup().addComponent(weightTextfield))
